...
async def init_default_settings():
    default_welcome = """Приветик. 
🌟 РАБОТА СТРИМ-МОДЕЛЬЮ В ПРИЛОЖЕНИИ HALO 🌟

💬 Заработок на общении, прямых эфирах и видеозвонках с мужчинами
📞 1 минута общения = 1$
💳 Комиссия агентства — 20%
👉 Чистый доход модели: 0.8$ за минуту нахождения в звонка

💵 От 50$ в день при активной работе
🌍 Аудитория: США, Европа, Англия, ОАЭ
🌐 Встроенный переводчик в чате — знание английского не обязательно
🕒 Свободный график — работаешь, когда удобно

💡 В открытых эфирах — только культурное общение

📤 Вывод средств:
Вывод делаешь самостоятельно
Вывод происходит в течении 1-3 дня
Вывод на Volet а с него → карта или крипта
...
— хорошее качество
— чётко видно лицо
(фото нужны только для внутреннего одобрения)
...
Если тебе подходит формат — жду фото 👋"""

    default_rejection = "Прости пожалуйста, но офис к сожалению отклонил твою анкету."
    
    default_approval = """Подключение к рабочей группе

После регистрации:
 • Присоединяйся к группе.
 • В группе есть закреплённое сообщение с полной информацией.
